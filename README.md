...
#### 1. 🏢 Advanced CRM/HRMS System
A comprehensive management system built to handle customer relations and human resources efficiently.
* **Live Demo:** [View Project](https://crm-hrms.vercel.app/)
* **Tech Stack:** MERN Stack (MongoDB, Express.js, React, Node.js)

#### 2. 🎓 Alumni Connect Platform
A full-stack networking platform for alumni to share opportunities and stay updated. Features a powerful admin dashboard built with Antigravity and React for bulk imports and analytics.
* **Live Demo:** [View Project](https://alumni-connection-frontend.vercel.app/)
* **Tech Stack:** MERN Stack, AWS, Antigravity

#### 3. 📺 Happy Star Satellite Vision
A production-level billing and subscription management system for cable TV operations, capable of handling complex transaction management.
* **Live Demo:** [View Project](https://happystarsatellitevision.netlify.app/)
